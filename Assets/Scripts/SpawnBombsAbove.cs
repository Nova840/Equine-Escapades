...
public class SpawnBombsAbove : MonoBehaviour {
    [SerializeField] BoxCollider spawnBox = null;
    [SerializeField] float spawnInterval = 5f;
    [SerializeField] GameObject bombToSpawn = null;
    ...
    private void Spawn(int numBombs) {
        for (int i = 0; i < numBombs; i++) {
            ...
            GameObject bomb = Instantiate(bombToSpawn, spawnPosition, Quaternion.identity);
